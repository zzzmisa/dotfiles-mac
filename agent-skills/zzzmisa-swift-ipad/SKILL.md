---
name: zzzmisa-swift-ipad
description: Use when the coding agent modifies AnimalVisionExplorer or another Swift/Xcode iOS app and the change needs real-device verification on ミサのiPad. Run the Release build targeting ミサのiPad by device name, then install it with devicectl targeting the same device name before reporting completion.
---

# Swift iPad Release Install
