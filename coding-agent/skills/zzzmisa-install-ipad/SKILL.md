...
description: Build the iOS Release and install it on the real device `ミサのiPad`. Use when a Flutter or Swift/Xcode iOS app change needs real-device verification on the iPad.
---
